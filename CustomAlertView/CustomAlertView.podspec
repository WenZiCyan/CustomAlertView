...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of CustomAlertView.自定义弹框"
  s.description  = <<-DESC
                   DESC

  s.homepage     = "http://EXAMPLE/CustomAlertView"
  ...
  s.source       = { :git => "http://EXAMPLE/CustomAlertView.git", :tag => "#{s.version}" }
